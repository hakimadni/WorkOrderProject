                    ...
                    <div class="container">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex align-items-center flex-equal">
                                ...
                                <!--begin::Logo image-->
                                <a href="/">
                                    <img alt="Logo" src="{{ asset('media/Developed by Hakeemu sticker.png') }}"
                                    ...
                                    <div class="menu menu-column flex-nowrap menu-rounded menu-lg-row menu-title-gray-500 menu-state-title-primary nav nav-flush fs-5 fw-bold"
                                        ...
                                        <div class="menu-item">
                                            <div class="flex-equal text-end ms-1">
                                                <h2 class="text-dark">Hi, @yield('Nama')</h2>
                                            </div>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        ...
                                        <div class="menu-item">
                                            ...
                                            <a class="menu-link nav-link py-3 px-4 px-xxl-6" href="#achievements"
                                                data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">History</a>
                                            <!--end::Menu link-->
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item">
                                            ...
                                            <a class="menu-link nav-link py-3 px-4 px-xxl-6" href="#team"
                                                data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">Our Goals</a>
                                            <!--end::Menu link-->
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item">
                                            ...
                                            <a class="menu-link nav-link py-3 px-4 px-xxl-6" href="#portfolio"
                                                data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">Benefits</a>
                                            <!--end::Menu link-->
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                            ...
                                            <div class="menu-item">
                                                <form method="POST" action="{{ route('logout') }}">
                                                    ...
                                                    <input type="submit" value="Logout"
                                                        class="btn btn-warning py-3 px-4 px-xxl-6">
